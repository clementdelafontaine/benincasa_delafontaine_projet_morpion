 ...
 * Par défaut : java morpion.ClientMorpion localhost 1234
 */
public class ClientMorpion {
    ...
    /**
     * Récupère, décrypte et affiche les données d'un plateau de jeu en recevant les données
     * directement via le BufferedReader passé en paramètre
     * @param in
     * @throws IOException
...
//        morpion.ClientMorpion client = new morpion.ClientMorpion(args[0], args[1]);
